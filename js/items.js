...
items.forEach(el => {
    out += 'id ' + el.id + '<br/>';
    out += 'category ' + el.category + '<br/>';
    out += '<img src="' + el.img +'">' + '<br/>';
    out += 'name ' + el.name + '<br/>';
    out += 'display ' + el.display + '<br/>';
    out += 'color ' + el.color + '<br/>';
    out += 'price' + el.price + '<br/>';
    out += 'chip' + el.chip + '<br/>';
    out += 'iram ' + el.ram + '<br/>';
    out += 'storage' + el.storage + '<br/>';
    out += 'touchId ' + el.touchId + '<br/>';
    out += 'faceId' + el.faceId + '<br/>';
    out += 'wireless' + el.wireless + '<br/>';
    out += 'camera' + el.camera + '<br/>';
    out += 'audio' + el.audio + '<br/>';
    out += 'size ' + el.size + '<br/>';
    out += 'os ' + el.os + '<br/>';
    out += 'InTheBox ' + el.InTheBox + '<br/>';
    out += 'orderInfo ' + el.orderInfo + '<br/>';
})

document.getElementsByClassName('cards-list').innerHTML = out;